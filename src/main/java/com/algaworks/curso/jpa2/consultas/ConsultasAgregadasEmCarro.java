...
import com.algaworks.curso.jpa2.consultas.info.AluguelCarroInfo;
...
public class ConsultasAgregadasEmCarro {
	...
	public static void main(String[] args) {
		...
		String jpql = "select NEW com.algaworks.curso.jpa2.consultas.info.AluguelCarroInfo(c, count(a), "
